                ...
                <GridItem xs={12} sm={6} md={6} lg={4}>
                  ...
                  <Dialog
                    ...
                    <DialogContent id='notice-modal-slide-description' className={classes.modalBody}>
                      <Instruction
                        ...
                        text={
                          <span>
                            ...
                            <a href='https://www.creative-tim.com/?ref=mkpr-javascript-components' target='_blank'>
                              Creative Tim
                            </a>
                            . You can choose a social network or go for the classic version, whatever works best for
                            you.
                          </span>
                        }
                        image={dg1}
                      ...
                      />
                      <p>
                        If you have more questions, don{"'"}t hesitate to contact us or send us a tweet @creativetim. We
                        {"'"}re here to help!
                      </p>
                    </DialogContent>
