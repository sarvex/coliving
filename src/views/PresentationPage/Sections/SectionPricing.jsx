                  ...
                  tabContent: (
                    <div className={classes.navPillsContent}>
                      <p className={classes.description}>
                        Good for personal websites, school projects, startups or any other project where your users will
                        not be charged for using it. Create one single website/app for one client.
                      </p>
