  ...
  return (
    <div className={classes.section}>
      <div
        ...
        style={{
          backgroundImage: `url(${require('Assets/Images/assets-for-demo/features-5.jpg')})`,
        }}>
          ...
          <GridContainer justify='center'>
            ...
            <GridItem sm={3} className={classes.featuresShow}>
              <InfoArea
                ...
                description={
                  <p>
                    This Material UI kit is built mobile-first and looks amazing on any device. Regardless of the screen
                    size, the website content will naturally fit the given resolution.
                  </p>
                }
                icon={PhoneLink}
                iconColor='gray'
            ...
            <GridItem sm={3} className={classes.featuresShow}>
              <InfoArea
                ...
                description={
                  <p>
                    Creating your design from scratch with dedicated designers can be very expensive. Using a kit is the
                    best option to start your development while bootstrapping your budget.
                  </p>
                }
                icon={AttachMoney}
                iconColor='gray'
                  ...
                  <GridItem md={9} sm={9}>
                    <CardBody plain className={classes.alignLeft}>
                      ...
                      <p className={classes.cardDescription}>
                        ...
                        {"'"}t the same anymore, I just can{"'"}t describe it guys! Thank you for this work!{'"'}
                      </p>
                    </CardBody>
                  </GridItem>
                </GridContainer>
