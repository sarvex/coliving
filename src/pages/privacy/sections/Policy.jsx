          ...
          <GridContainer>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              ...
              <h5 className={classes.description}>
                This policy is an integral part of the [Terms of Use] of Coliving Technologies Pvt. Ltd. (the “Company” or “ Us ” or “ Our ” or “ We ”) and must be read along with the same. All capitalised terms not defined under this Agreement shall have the meaning ascribed to it under the [Terms of Use] as published on the website. ‘Housr’, operated and managed, by Us adheres strictly to the applicable information technology and data protection laws, rules and regulations. This policy sets out the manner in which the Company handles or deals with the information or data provided by the users and registrants (“ You ” or “ Your ” or “ Yourself ” or “ User ”) of the website ‘Gohousr.com’ including any mobile site, applications for iOS, Android, Windows operating system and/or any software application owned and operated by the Company (collectively referred to as, the “ Platform ”). Please read the terms of this Agreement carefully before using or registering on the Platform or accessing any material, information or [Platform Services] (as defined hereinafter ) through the Platform. Your use of the Platform or the Platform Services shall signify your acceptance of this Agreement, the [Terms of Use] including but not limited to Your consent for collection, using or sharing your information as per this Agreement and Your agreement to be legally bound by the same.
              </h5>
            </GridItem>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Statement of Privacy practice and policy</h3>
              <h5 className={classes.description}>
            ...
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Collection of Information by Third-Party Sites and Advertisers</h3>
              <h5 className={classes.description}>
            ...
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              ...
              <h5 className={classes.description}>
                The Company has implemented reasonable security practice and procedure to protect Your information or sensitive personal information as provided by You. The Company’s security procedure and practice is complied with Information Technology (Reasonable security practices and procedures and personal sensitive data or information) Rules, 2011.
              </h5>
            </GridItem>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>User Discretion</h3>
              <h5 className={classes.description}>
                You may opt out of receiving promotional emails from the Company by following the instructions in those emails. If You opt out, the Company may still send You non-promotional emails, such as emails about the Platform Services and Your account.
              </h5>
              <h5 className={classes.description}>
                Cookie choices:  Most web browsers are set to accept cookies by default. If You prefer, You can usually choose to set Your browser to remove or reject cookies. If You choose to remove or reject cookies, this could affect certain features or Platform Services.
              </h5>
              <h5 className={classes.description}>
                This Agreement is made easily accessible and readable for You. In case, You need to review Your information or sensitive personal information, You need to directly write to us at social@coliving.ai, and we shall update any information or sensitive personal information which is inaccurate or deficient.
              </h5>
              <h5 className={classes.description}>
            ...
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Right to withdraw Consent</h3>
              <h5 className={classes.description}>
                You may choose to withdraw Your consent provided hereunder at any point in time. Such withdrawal of the consent must be sent in writing to social@coliving.ai. In case You do not provide or later on withdrawing Your consent, We reserve the option to not provide Platform Services, or the goods or services for which the said information was sought on the Platform.
              </h5>
            </GridItem>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Grievances</h3>
              <h5 className={classes.description}>
                In the event You have any grievances relating to this Agreement, please inform the Company within 24 hours of occurrence of the instance from which the grievance has arisen, by writing an email to us at social@coliving.ai.
              </h5>
            </GridItem>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Amendments</h3>
              <h5 className={classes.description}>
            ...
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Governing Law</h3>
              <h5 className={classes.description}>
                This Agreement shall be governed by the laws of India and the parties hereby irrevocably attorn to the exclusive jurisdiction of the courts at Bangalore, India with respect to any dispute arising under this Agreement.
              </h5>
            </GridItem>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
              <h3 className={classes.title}>Dispute Resolution</h3>
              <h5 className={classes.description}>
                Any dispute, controversy or claim arising out of or relating to this Agreement, or the breach, termination or invalidity thereof, shall be settled by arbitration in accordance with the arbitration of the Sole Arbitrator appointed mutually by both the Parties and governed by the rules of the The Arbitration and Conciliation Act 1996 as amended from time to time. The seat and venue of the arbitration proceedings shall be at Bengaluru and the arbitration shall be conducted in English. Any arbitration award shall be final and binding on each of the Parties that were parties to the dispute.
              </h5>
            </GridItem>
            <GridItem xs={12} sm={12} md={12} className={`${classes.mlAuto  } ${  classes.mrAuto}`}>
